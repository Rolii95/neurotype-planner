        ...
        <div className="p-6 overflow-y-auto max-h-[calc(80vh-120px)]">
          ...
          <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            ...
            <ul className="space-y-1 text-sm text-blue-800 dark:text-blue-300">
              <li>• Press <kbd className="px-1.5 py-0.5 bg-white dark:bg-blue-950 rounded text-xs">?</kbd> anytime to open this help dialog</li>
              <li>• Press <kbd className="px-1.5 py-0.5 bg-white dark:bg-blue-950 rounded text-xs">Ctrl+K</kbd> to access the command palette for quick navigation</li>
